...
#SBATCH -o "log/run_attack_csgld_pgd__nb_cycles_10K_%j.log"
...
for i in $(seq 1 15); do
  ...
  # 4 minutes 30 sec for 1K examples
  ...
  print_time
  # 6 min 30 sec for 1K examples
  # 29 minutes and 30 seconds for 10K examples
done
