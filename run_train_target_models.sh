...
# similar HP than https://github.com/BIGBALLON/CIFAR-ZOO/blob/master/experiments/cifar10/lenet/config.yaml
#python -u train.py ./models_target CIFAR10 LeNet Adam --lr 0.01 --lr-decay 75 --lr-decay-gamma 0.1 --prior-sigma 100 --epochs 250 --seed $SEED $ARGS
print_time
# similar HP than https://github.com/BIGBALLON/CIFAR-ZOO/blob/master/experiments/cifar10/preresnet110/config.yaml
# should take approx 4h30
...
# similar HP to https://github.com/kuangliu/pytorch-cifar
#python -u train.py ./models_target CIFAR10 resnet50 Adam --lr 0.01 --lr-decay 75 --lr-decay-gamma 0.1 --prior-sigma 100 --epochs 250 --seed $SEED $ARGS
print_time
...
print_time # ~ 9h conservative estimate
