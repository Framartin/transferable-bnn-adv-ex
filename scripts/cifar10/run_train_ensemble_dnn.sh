...
# train 4 DNNs for each architecture (same #epochs than cSGLD with 3x5 samples)
python -u train.py ./models CIFAR10 PreResNet110 Adam --lr 0.01 --lr-decay 75 --lr-decay-gamma 0.1 --prior-sigma 100 --epochs 250 --models 3 --seed $SEED $ARGS
