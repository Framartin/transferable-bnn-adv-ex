...
#SBATCH -o "log/imagenet/run_attack_csgld_pgd__multiple_archs_%j.log"
...
# launch with:
# bash scripts/imagenet/run_attack_csgld_pgd__multiple_archs.sh >>log/imagenet/run_attack_csgld_pgd__multiple_archs.log 2>&1
...
# restrict number of cycles to 3 (resnet-50 has 5 cycles available)
