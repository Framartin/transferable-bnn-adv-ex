...
#should take XX days
# launch with:
# bash scripts/imagenet/dnn_130to135epochs/train_dnn_mnasnet.sh >>log/imagenet/dnn_130to135epochs/run_train_dnn_mnasnet.log 2>&1
...
python -u train_dnn_imagenet.py --data $DATAPATH --no-normalization --arch $ARCH \
  ...
  --resume "models/ImageNet/mnasnet1_0/single_model/checkpoints/ImageNet-SGD_mnasnet1_0_lr0.1_ep00129.pt.tar"
