#!/bin/bash -l
# launch with:
# bash scripts/imagenet/dnn_130to135epochs/train_dnn_efficientnet_resume.sh >>log/imagenet/dnn_130to135epochs/run_train_dnn_efficientnet.log 2>&1
...
python -u train_dnn_imagenet.py --data $DATAPATH --no-normalization --arch $ARCH \
  ...
  --resume "models/ImageNet/efficientnet_b0/single_model/checkpoints/ImageNet-SGD_efficientnet_b0_lr0.1_ep00129.pt.tar"
