"""
Compute the L2 norm of gradients on ImageNet on all test examples
...
ensemble_path = list_models("models/CIFAR10/PreResNet110/cSGLD_cycles5_savespercycle3_it1")  # BNN
#ensemble_path = list_models("models/CIFAR10/PreResNet110/dnn_ensemble/Adam_bs128_lr0.01_lrd75_psig100.0_ep250_seed50") # DNN
